...
def test_dcf_reports_equity_only_across_a_net_debt_bridge():
    """Enterprise value under the equity name would count the debt as the owners'."""
    ...
    codes = [o.code for o in calculate("dcf", without).outputs]
    assert codes == ["dcf_enterprise_value"]
